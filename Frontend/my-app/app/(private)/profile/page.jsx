...
function page() {
  return (
    <div className="min-h-screen bg-[#222126]  text-white ">
      <div className="mx-auto flex  w-full  rounded-2xl border border-white/5 bg-[#0d0b10] shadow-2xl shadow-black/30">
        {/* Left Sidebar */}
        <aside className="hidden w-[230px] shrink-0 border-r border-white/5 bg-[#18171d] p-4 md:block">
          <button className="mb-7 flex items-center gap-2 text-sm font-medium text-zinc-200 transition hover:text-white">
            <ArrowLeft size={16} />
            Back
          </button>

          <nav className="space-y-2">
            <button className="flex w-full items-center gap-3 rounded-md bg-[#2b2934] px-3 py-2.5 text-left text-sm font-medium text-white">
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#6d35ff]">
                <User size={13} />
              </span>
              Account
            </button>

            <button className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-left text-sm font-medium text-zinc-500 transition hover:bg-white/5 hover:text-zinc-200">
        ...
        {/* Main Content */}
        <main className="min-w-0 flex-1 bg-[#0d0b10]">
          {/* Top Bar */}
          <div className="flex flex-col gap-4 border-b border-white/5 px-5 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <button className="flex h-9 items-center justify-center gap-2 rounded-md bg-[#6d35ff] px-4 text-sm font-semibold text-white transition hover:bg-[#7c4dff]">
                <Plus size={16} />
                New Video
              </button>
            </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <button className="flex h-8 items-center gap-2 rounded-md bg-[#2a2731] px-3 text-xs font-semibold text-zinc-100 transition hover:bg-[#34313d]">
                      <Upload size={13} />
                      Change Profile
                    </button>
