            ...
            <div className="mb-5 flex items-center justify-between">
              ...
              <div className="flex gap-2 ">
                <button
                  onClick={OpenModal}
                  type="button"
                  className="flex h-12 w-12 items-center hover:cursor-pointer justify-center rounded-xl border border-white/10 bg-white/[0.04] text-lg font-bold text-white transition hover:bg-white hover:text-black"
                >
                  +
                </button>
                ...
                <span
                  ...
                  className="flex p-2.5 items-center hover:cursor-pointer justify-center rounded-xl border border-white/10 bg-white/[0.04] text-lg font-bold text-white transition hover:bg-white hover:text-black"
                >
                  <Users size={15} /> {" +"}
                </span>
              </div>
